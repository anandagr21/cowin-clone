...
export const api_one = async (state_id = "", district_id = "", date = new Date()) => {
    return await axios.get(`https://api.cowin.gov.in/api/v1/reports/v2/getPublicReports?state_id=${state_id}&district_id=${district_id}&date=${getDate(date)}`)
}

export const api_two = async (state_id = "", district_id = "", date = new Date()) => {
    return await axios.get(`https://api.cowin.gov.in/api/v1/reports/v2/getVacPublicReports?state_id=${state_id}&district_id=${district_id}&date=${getDate(date)}`)
}
